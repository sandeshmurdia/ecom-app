...
// eslint-disable-next-line react-refresh/only-export-components -- This file exports a hook alongside the provider by design.
...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      ...
      // Surface real failures to callers while keeping user messaging centralized here.
