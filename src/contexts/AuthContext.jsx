...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      ...
      // Surface login failures to the caller so the UI can show an error state.
      // The previous behavior silently swallowed errors, which made the app appear "stuck" on failures.
